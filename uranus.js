...
bz_sbt=3.194e-09  //Bz_needed_in_pressure_balance constant for each
  
x_nose_MP_sbt=24 //URANUS
...
let layout = {
    ...
    paper_bgcolor: '#ace', 
    barmode: 'relative',
    yaxis: {title: 'Y [R<sub>Uranus</sub>]', range: [-60, 60], dtick: 15},
    xaxis: {title: 'X [R<sub>Uranus</sub>]', range: [-60, 60], dtick: 15}};
