const plotButtonJupiter=document.getElementById("plotBtnJupiter")

////////// INPUTS FROM USER ///////////////
let u_swEl_J= document.getElementById("Input1J")
let n_swEl_J=document.getElementById("Input2J")
let roEl_J=document.getElementById("Input3J")
let kappaEl_J=document.getElementById("Input4J")
let eccEl_J=document.getElementById("Input5J")
let bsEl_J=document.getElementById("Input6J")



////Clicking the Plot button makes the Plot visible///////////////

plotButtonJupiter.addEventListener("click", function(){

  let u_sw=parseFloat(u_swEl_J.value)
  let n_sw=parseFloat(n_swEl_J.value)
  let ro=parseFloat(roEl_J.value)
  let kappa=parseFloat(kappaEl_J.value)
  let ecc=parseFloat(eccEl_J.value)
  let bs=parseFloat(bsEl_J.value)
...
let layout = {
    ...
    paper_bgcolor: '#ace', 
    barmode: 'relative',
    yaxis: {title: 'Y [R<sub>Jupiter</sub>]', range: [-150, 150], dtick: 25},
    xaxis: {title: 'X [R<sub>Jupiter</sub>]', range: [-150, 150]}};
