...
bz_sbt=2.0374e-09  //Bz_needed_in_pressure_balance constant for each
  
x_nose_MP_sbt=23 //neptune
...
let layout = {
    ...
    paper_bgcolor: '#ace', 
    barmode: 'relative',
    yaxis: {title: 'Y [R<sub>Neptune</sub>]', range: [-60, 60], dtick: 15},
    xaxis: {title: 'X [R<sub>Neptune</sub>]', range: [-60, 60], dtick: 15}};
